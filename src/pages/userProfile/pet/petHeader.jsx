...
export const PetHeader = () => {
	...
	return (
		<header>
			<div className="flex font-normal items-center justify-between shadowxl:p-10 p-4 h-30 text-4xl md:p-5">
				<button id="teste" className="mx-2 rounded focus:outline-none" onClick={() => {/*TODO*/}}>
				...
				<Link
					to="/"
					className=" md:pt-1 text-1xl sm:flex font-bold my-0 mx-auto"
				>
					PetSaúde
				</Link>
				<Link to={linkTo} className=" md:flex flex-row gap-2">
					<img src={userFoto} className="w-14 h-14 p-1 md:p-0 rounded-full" alt="Profile"/>
