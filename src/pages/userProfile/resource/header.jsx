...
export const HeaderProfile = () => {
	return (
		<header className="flex font-normal justify-between md:pb-5 md:h-30 text-4xl items-center md:px-12 md:pt-5 relative">
			<button id='menu-button' className="block py-3 md:px-4 mx-2 rounded focus:outline-none hover-bg-gray-200 group z-10">
			...
			<Link to='/profile/configuration' className="flex items-center gap-2 justify-center p-2 md:pt-2 z-10" >
