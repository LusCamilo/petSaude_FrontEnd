...
=======
            <header>
            <div className="flex font-normal items-center justify-between bg-[#9ED1B7] shadow xl:p-10 h-30 text-4xl md:p-5">
              ...
              <Link to={linkTo} className=" md:flex flex-row gap-2">
                ...
                <div className="flex flex-col justify-items-center text-center  gap-20 bg-[#9ED1B7]  ">
                  <div className="flex flex-col justify-center w-full basis-1/4 content-center items-center gap-20 ">
                      <h1 className="font-bold text-4xl md:text-7xl h-3/4 rounded-3xl bg-[#78A890] xl:text-9xl mt-20  hidden md:flex justify-center content-center items-center px-20 py-10"> {props.title}</h1>
                      <p className="md:flex justify-center xl:text-center text-2xl md:text-4xl  w-full  hidden "> {props.description} </p>
                  </div>
                  <img className=" md:mr-80 md:pr-20 pt-0 w-full" src={FootHeader}/>          
                </div>
...
>>>>>>> 82eecfb (responsive search)
          ...
          <Link to='../home' className=" text-1xl sm:flex justify-start font-bold">PetSaúde</Link>
          <nav>
          ...
          <div className="md:flex flex-direction " >
            <img className="pt-10 pr-1 md:pt-1 w-10" src={userFoto} />
            <Link to="/profile" class=" hidden xl:block home-btn p-1 ">
              {userNome}
            </Link>
          </div>
