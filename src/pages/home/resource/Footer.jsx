            ...
            <div className="bg-[#9ED1B7] flex flex-col pt-10 md:pt-28 mt-10 pb-10 md:pb-0">
                <div className=" flex justify-center items-center flex-row">
                    <div className="basis-1/3 md:basis-1/4 w-1/8 flex items-center justify-evenly flex-col">
                        ...
                        <p className="break-words ml-20 w-24 md:w-56 font-montserrat text-xs md:text-base miniSize">Nossos serviços estão dispóniveis a qualquer hora e em qualque lugar!</p>
                    </div>
