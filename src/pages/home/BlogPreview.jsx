...
export const BlogPreview = () => {
    return (
        ...
        <div className='flex flex-col justify-center items-center'>
            <h2 className="sm:text-5xl text-center font-semibold pt-20 sm:w-1/3 ">Blog PetSaúde</h2>
        <div className='md:flex flex-row justify-center sm:flew-col gap-32 pt-20 md:p-20 w-full'>
                <div className='flex flex-col justify-center border-4 border-[#78A890] sm:w-1/5 h-full text-center drop-shadow-lg rounded-lg p-5 '>
                ...
                <div className='flex flex-col justify-center border-4 border-[#78A890]  sm:w-1/5 h-full text-center drop-shadow-lg rounded-lg p-5 mt-14 md:mt-0'>
                   
                        <img src={WalkDog}></img>
                        <h3 className='text-2xl pt-5'>Importancia de levar seus pets para passear.</h3>
            ...
            <div className='flex justify-center items-center w-96 h-20 border bg-[#78A890] rounded-lg'>
