		...
		<section>
			<div className='flex flex-col justify-center items-center'>
				...
				<div className='md:flex md:flex-row justify-center sm:flew-col gap-32 sm:pt-20 md:p-20 w-full'>
					<div className='hidden md:flex flex-col ml-16 md:ml-0 justify-center border-4 border-[#78A890]  w-2/3 md:w-96 h-full text-center drop-shadow-lg rounded-lg p-5 mt-14 md:mt-0'>

						<img src={DogFood} alt='Dog and cat eating' />
					...
					<div className='flex flex-col ml-16 md:ml-0 justify-center border-4 border-[#78A890]  w-2/3 md:w-96 h-full text-center drop-shadow-lg rounded-lg p-5 mt-14 md:mt-0'>

						<img className='w-72 sm:w-full' src={WalkDog} alt='Person walking with a dog' />
					...
					<div className='hidden md:flex flex-col justify-center border-4 border-[#78A890] md:w-96 h-full text-center drop-shadow-lg rounded-lg p-5 mt-14 md:mt-0'>

						<img src={Vaccine} alt='Cat getting vaccinated' />
				...
				<div className='flex justify-center items-center p-5 sm:p-0 sm:w-96 h-20 border bg-[#78A890] rounded-lg mt-10 md:mt-0'>
					<button className='flex gap-5 text-xl'>
						...
						Visite nosso Blog
						<img className='sm:w-20' src={Arrow} alt='Arrow' />
					</button>
				</div>
			</div>
		</section>
