...
export const AboutUs = () => {
	return (
		<section>
			...
			<div className="flex h-full flex-col w-full md:flex-row md:items-center break-words pt-10 mb-20">
				...
				<div className="flex h-full w-full justify-end md:justify-start items-end md:items-center mx-1 flex-col gap-5 p-5">
					...
					<div >
						<p className="text-sm md:text-2xl w-full font-semibold text-justify break-words font-montserrat mb-3 pr-28 pl-10 pt-5">
						...
						<p className="text-sm md:text-2xl font-semibold text-justify break-words font-montserrat pr-28 pl-10 pt-3">
