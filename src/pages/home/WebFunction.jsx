...
export const WebFunction = () => {
    return (
        <>
        <div className='flex flex-col justify-center items-center  bg-[#9ED1B7] '>
            <h2 className="sm:text-5xl font-semibold pt-20 sm:w-1/3 ">A PetSaúde tem tudo que você precisa para manter a saúde de seu Pet em dia!</h2>
        <div className='md:flex flex-row justify-center sm:flew-col gap-32 pt-20 md:p-20 w-full'>
                <div className='bg-[#78A890] sm:w-1/5 h-80 text-center drop-shadow-lg rounded-lg p-5 '>
                ...
                <div className='bg-[#78A890] sm:w-1/5 h-80 text-center drop-shadow-lg rounded-lg p-5 mt-14 md:mt-0'>
                    <div className='flex gap-3'>
                        <img src={calendary}></img>
                        <h3 className='text-white text-2xl pt-5'>Pesquise e encontre nossas diversas opções!</h3>
                    </div>
                    <p className='text-white text-xl  text-center pt-10'>Com nosso sistema de busca, é 
