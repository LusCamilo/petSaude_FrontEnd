	...
	const submitForm = async data => {
		...
		if (validateForm(data)) {
			...
			if (response.id) {
				...
				await updateSpecialitiesPet(JSON.stringify({ AnimalTypesVetInfos: attendedAnimals })).then(
					await updateSpecialities(JSON.stringify({ specialties: specialities })).then(
